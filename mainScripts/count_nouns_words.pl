...
$main_output = $file_name . "_nouns_words";
...
if ($x =~ /_NOUN/ || $x_1 =~ /_NOUN/ || $x_2 =~ /_NOUN/) { 
...
if ($x =~ /_NOUN/ || $x_1 =~ /_NOUN/ || $x_2 =~ /_NOUN/ || $x_3 =~ /_NOUN/) { 
...
if ($x =~ /_NOUN/ || $x_1 =~ /_NOUN/ || $x_2 =~ /_NOUN/ || $x_3 =~ /_NOUN/ || $x_4 =~ /_NOUN/) { 
